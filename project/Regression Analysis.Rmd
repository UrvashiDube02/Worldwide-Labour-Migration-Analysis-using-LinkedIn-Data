...
```{r}
df = read_csv("app/www/data/country_migration.csv")
# head(df)
...
country_wise_net_per_year_rf_skill = read_csv("country_migration_public.csv")

country_wise_net_per_year_rf_skill <- country_wise_net_per_year_rf_skill %>% group_by(base_country_name) %>% summarise(net_per_10K_2015 = sum(net_per_10K_2015), net_per_10K_2016 = sum(net_per_10K_2016), net_per_10K_2017 = sum(net_per_10K_2017), net_per_10K_2018 = sum(net_per_10K_2018), net_per_10K_2019 = sum(net_per_10K_2019))
...
country_wise_net_rf_country_skill <- country_wise_net_per_year_rf_skill %>%filter(base_country_name %in% Country)
